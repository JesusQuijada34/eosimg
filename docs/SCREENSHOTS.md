...
| `build/captures/etternhall-desktop-final.png` | Captura final del escritorio de desarrollo con panel, BlinkE, workspaces 1/2/3, Archivos y Notas | `eos-phone-shell --capture` | 1280×800 |
